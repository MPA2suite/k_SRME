...
in_folder = f"2024-11-25-{model_name}-phononDB-LTC-FIRE_2SR_force0.0001_sym1e-05/"
...
mSRE_success, mSRME_success = get_success_metrics(df_mlp_filtered)

print(f"\tmean SRME for successful runs: {mSRME_success}")
print(f"\tmean SRE for successful runs: {mSRE_success}")
