...
# EDITABLE CONFIG
model_name = "eqV2"
checkpoint = f"eqV2_31M_omat_mp_salex.pt"
import torch
from fairchem.core import OCPCalculator
   
POTENTIAL_PATH = f'/mnt/scratch2/q13camb_scratch/POTENTIALS/foundational/eqV2/{checkpoint}'

device = "cuda" if torch.cuda.is_available() else "cpu"
calc =  OCPCalculator(checkpoint_path=POTENTIAL_PATH,cpu=(device=="cpu"),seed=0) 
