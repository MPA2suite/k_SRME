...
in_folder = f"2024-11-20-{model_name}-phononDB-LTC-FIRE_2SR_force0.0001_sym1e-05/"

# Comparing with the DFT results without
# non-analytical correction term (NAC), which is in closer agreement with to MLP results
